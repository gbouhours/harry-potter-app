<template>
  <div>
    <div>
      <label class="block mb-2 font-bold text-left">Titre du film</label>
      ...
      <input
        ...
        placeholder="Pour une poignée de dollars"
        autocomplete="off"
        @keyup="validateInput"
        @blur="validateInput"
...
export default {
  ...
  setup(props) {
    ...
    const { validateTitleField, errors } = useFormValidation();
    const validateInput = () => {
